...
const Modal: FC<ModalProps> = ({ trigger, modalOpen, setModalOpen }) => {
  ...
  return (
    <div
      className={`fixed left-0 top-0 flex h-full min-h-screen w-full items-center justify-center bg-black/90 px-4 py-5 z-50 ${
    ...
    >
      ...
      >
        ...
        <div className="-mx-3 flex flex-wrap">
          ...
          <div className="w-1/2 px-3">
            <button className="block w-full rounded-md border border-primary bg-blue-400 p-3 text-center text-base font-medium text-white transition hover:bg-blue-dark">
              <a>Vier</a>
            </button>
          </div>
        </div>
